...
def create_hulproductmaster():
    ...
    try:
        ...
        cursor.execute('CREATE TABLE HUL_Product_Master('
                       'Barcode VARCHAR(50) NOT NULL PRIMARY KEY,'
                       'Category_Desc VARCHAR(100) NOT NULL,'
                       'Subcategory_Desc VARCHAR(100) NOT NULL,'
                       'Brand_Desc VARCHAR(100) NOT NULL,'
                       'Basepack_Desc VARCHAR(100) NOT NULL,'
                       'Price DOUBLE NOT NULL)'
                       ';')
        print("Table HUL_Product_Master created successfully.")
